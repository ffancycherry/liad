...
import { useEventsFilters } from '@/hooks/useEventsCurrentFilters'
import { $events } from '@/context/events-current'
import Link from 'next/link'

const EventsCurrentPage = ({ searchParams }: IEventsPage) => {
  ...
  return (
    <>
      <h1 className={styles.events__title}>
        ...
        <Link
          href='/events/events-completed'
          className={styles.events__link__completed}
        >
          Итоги мероприятий
        </Link>
      </h1>
...
export default EventsCurrentPage
